...
copilot_appid=`linera --with-wallet 0 create-application $copilot_bid --json-parameters "{\"cp_registry_app_id\":\"$cp_registry_appid\"}" --required-application-ids $cp_registry_appid`
